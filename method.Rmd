...
* **Probability of severe illness**: Our risk model provides estimates of COVID-19 illness severity probabilities due to biological risk factors for COVID alone (age, comorbidities, obesity, smoking). This can be seen as a "baseline" biological risk model, whereas a multitude of exogenous factors may impact what we observe on the epidemic, including:
...
* Incorporating the latest information into our models will be key to maintaining its relevance for policy and analysis. 
