...
## (3.3) Prior parameter specifications {.tabset}
...
p <- ggplot(R0_t_plot, aes(x=day, y=R0_t)) +
  ...
  scale_x_date(date_breaks = "2 weeks",limit=c(as.Date("2020-03-01"),as.Date("2020-06-01"))) + ggtitle("R0(t), with model-estimated reduction trend")
p
```
