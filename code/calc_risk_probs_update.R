...
Pr.D = read.table(paste0(data.dir, "Ordinal.Age.DummyRiskProfile.Death.txt"), sep=" ", header=TRUE )
Pr.H = read.table(paste0(data.dir, "Ordinal.Age.DummyRiskProfile.Hospitalization.txt"), sep=" ", header=TRUE )
Pr.Q = read.table(paste0(data.dir, "Ordinal.Age.DummyRiskProfile.ICU.txt"), sep=" ", header=TRUE )
...
write.csv(Pr.H, file = paste0(data.dir, "Ordinal.Comb.Pr.H.ByProfile.csv"))
write.csv(Pr.Q, file = paste0(data.dir, "Ordinal.Comb.Pr.Q.ByProfile.csv"))
write.csv(Pr.D, file = paste0(data.dir, "Ordinal.Comb.Pr.D.ByProfile.csv"))
...
data.dir="/Users/abigailhorn/Dropbox/0 2019/COVID-19/LACounty_modeling/data/Pop.prevalence/"
SIGMA2 = read.csv(paste0(data.dir, "Pop.prevalence.corr.csv"), sep=",", header=TRUE,row.names = 1)
Pop.prevalence = read.csv(paste0(data.dir, "Pop.prevalence.csv"), sep=",", header=TRUE,row.names = 1 )
