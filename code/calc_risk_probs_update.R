...
write.csv(Pr.H, file = path(data.dir, "Pr.H.BMI.csv"))
write.csv(Pr.Q, file = path(data.dir, "Pr.Q.BMI.csv"))
write.csv(Pr.D, file = path(data.dir, "Pr.D.BMI.csv"))
...
SIGMA2 <- dplyr::select(SIGMA.BMI, -c(stroke,hepB,kidney))
...
data.dir = here("results")
write.csv(profile.cnt.SPAs, file = path(data.dir, "ProfilePrev.GeneralPop.csv"))
write.csv(H.profile.share.relative.all.SPAs, file = path(data.dir, "ProfilePrev.HospitalPop.csv"))
write.csv(Q.profile.share.relative.all.SPAs, file = path(data.dir, "ProfilePrev.ICUPop.csv"))
write.csv(D.profile.share.relative.all.SPAs, file = path(data.dir, "ProfilePrev.DeadPop.csv"))
