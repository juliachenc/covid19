...
model.1sim.stats.no.R <- function(par){
  ...
  Alpha_t = c(0, 45, 52, 59, 66)
  Kappa_t = c(0, 45, 52, 59, 66)
  Beta_t = c(0, 45, 52, 59, 66)
  Delta_t = c(0, 45, 52, 59, 66)
  r_t = c(0, 45, 52, 59, 66)
  
  Delta_y = c(week_par_mean[1,3],week_par_mean[1,3], week_par_mean[2,3], week_par_mean[3,3], Delta)
  Kappa_y = c(week_par_mean[1,5],week_par_mean[1,5],week_par_mean[2,5], week_par_mean[3,5], Kappa)
  Alpha_y = c(week_par_mean[1,4],week_par_mean[1,4],week_par_mean[2,4], week_par_mean[3,4], Alpha)
  r_y = c(week_par_mean[1,2], week_par_mean[1,2], week_par_mean[2,2], week_par_mean[3,2], r)
  p_QV = c(week_par_mean[1,6], week_par_mean[1,6],week_par_mean[2,6], week_par_mean[3,6],p_V)
  #For week 1 - R0_t
  R0_y <- c(week_par_mean[1,1],week_par_mean[1,1],week_par_mean[2,1], week_par_mean[3,1],R0)
  ...
  Beta_y =  c(Br.function(R0.in<-R0_y[1], r.in<-r, Alpha.in<-Alpha),
              ...
              Br.function(R0.in<-R0_y[5], r.in<-r, Alpha.in<-Alpha))
