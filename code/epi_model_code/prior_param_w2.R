...
# Delta
prior.Delta = c("normal", week_par_mean[1,3], week_par_sd[1,3])
# Alpha
prior.Alpha = c("normal", week_par_mean[1,4], week_par_sd[1,4])
# Kappa
prior.Kappa = c("normal", week_par_mean[1,5], week_par_sd[1,5])
# p_V
prior.p_V = c("normal", week_par_mean[1,6], week_par_sd[1,6])
