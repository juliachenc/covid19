...
write.csv(Pr.H, file = paste0(result.dir, "Pr.H.BMI.csv"))
write.csv(Pr.Q, file = paste0(result.dir, "Pr.Q.BMI.csv"))
write.csv(Pr.D, file = paste0(result.dir, "Pr.D.BMI.csv"))
...
# write.csv(profile.cnt.SPAs, file = paste0(result.dir, "ProfilePrev.GeneralPop.csv"))
# write.csv(H.profile.share.relative.all.SPAs, file = paste0(result.dir, "ProfilePrev.HospitalPop.csv"))
# write.csv(Q.profile.share.relative.all.SPAs, file = paste0(result.dir, "ProfilePrev.ICUPop.csv"))
# write.csv(D.profile.share.relative.all.SPAs, file = paste0(result.dir, "ProfilePrev.DeadPop.csv"))
...
write.csv(risk.probs.SPAs, file = paste0(result.dir, "Over.SPAs.Risk.Probs.csv"))
