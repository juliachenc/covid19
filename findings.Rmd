...
* L.A. County has succeeded in mitigating a large initial epidemic wave due to early action and strong adherence to social distancing (the model-estimated reduction in contact rate from pre-pandemic times to that seen in the months of April and May is >70%). However the slight but steady increase in mobility and social encounters observed in the mobility data (around a 25% increase from beginning of May to beginning of June) translates into a long plateaued epidemic curve over the upcoming months.
* Model predictions suggest that the average population contact rate may be increased by as much as a 50-100% increase in social encounters above the behavior observed in the first phase of response (Level 1, April), while still keeping the epidemic at controllable levels in terms of heathcare resource capacity. However, if social encounters increase beyond 100% from that initial phase, a resurgence and second wave of the epidemic can and will be seen. What exactly does an 50% (or equivalently, a two-fold) increase in contact rate from Level 1 social distancing translate to? Does this mean people can spend time with twice as many contacts as they were in April? Questions of this specificity cannot be answered by the single-population model developed in this work. Finer-resolution micro-simulation models combined with analysis of near-real-time mobility data will be needed to provide practical answers to questions at this level of detail.
