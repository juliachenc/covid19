...
# prior.st <- c("unif",30,50) 
# prior.R0.redux1 <- c("unif", R0_redux1 - 0.1, R0_redux1 + 0.1)  #c("normal",R0_redux, 0.05) 
# prior.Delta <- c("normal",Delta,0.001) 
# prior.Alpha <- c("normal",Alpha, 0.3) 
# prior.Kappa <- c("normal",Kappa, 0.3)
# prior.p_V <- c("unif", p_V-0.3, p_V+0.3 ) #c("normal",p_V, 0.08)
# prior.R0.redux2 <- c("unif", R0_redux2 - 0.1, R0_redux2 + 0.1)  #c("normal",R0_redux, 0.05) 

# prior.R0 <- c("normal",4.1,.0015)
# #prior.r <- c("unif", .005, .035) # c("normal",r,0.01)
# prior.st <- c("unif",30,50)
# R0_redux1 <- .2
# prior.R0.redux1 <- c("unif", R0_redux1 - 0.01, R0_redux1 + 0.01)  #c("normal",R0_redux, 0.05)
# prior.Delta <- c("normal",0.7,0.001)
# prior.Alpha <- c("normal",.14, 0.001)
# prior.Kappa <- c("normal",.5, 0.003)
# p_V <- 0.4
# prior.p_V <- c("unif", p_V-0.01, p_V+0.01 ) #c("normal",p_V, 0.08)
# R0_redux2 <- .45
# prior.R0.redux2 <- c("unif", R0_redux2 - 0.01, R0_redux2 + 0.01)  #c("normal",R0_redux, 0.05)
# prior.r <- c("unif",0.07, 0.08)

# prior.R0 <- c("normal",4.0,.0015)
# #prior.r <- c("unif", .005, .035) # c("normal",r,0.01)
# prior.st <- c("unif",30,50)
# R0_redux1 <- .2
# prior.R0.redux1 <- c("unif", R0_redux1 - 0.01, R0_redux1 + 0.01)  #c("normal",R0_redux, 0.05)
# prior.Delta <- c("normal",0.6,0.001)
# prior.Alpha <- c("normal",.14, 0.001)
# prior.Kappa <- c("normal",.6, 0.003)
# p_V <- 0.4
# prior.p_V <- c("unif", p_V-0.01, p_V+0.01 ) #c("normal",p_V, 0.08)
# R0_redux2 <- .45
# prior.R0.redux2 <- c("unif", R0_redux2 - 0.01, R0_redux2 + 0.01)  #c("normal",R0_redux, 0.05)
# prior.r <- c("unif",0.025, 0.2)

## A list joining the prior for each parameter
prior.st <- c("unif",40,50)
prior.Delta <- c("normal",0.55,0.01)
prior.Alpha <- c("normal",Alpha, 0.003)
...
# prior.R0.redux1 <- c("unif", R0_redux1 - 0.03, R0_redux1 + 0.03)  #c("normal",R0_redux, 0.05)
# prior.R0.redux2 <- c("unif", R0_redux2 - 0.1, R0_redux2 + 0.1)
