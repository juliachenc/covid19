...
path_seihqdr_model <- path(code.dir/code_paper, "stochastic_SEIAHQDR_Alpha_t_paper.R")
...
supporting_functions <- path(code.dir/code_paper, "supporting_fns_Alpha_t_paper.R")
...
prior.r <- c("unif",0.03, 0.6) #c("unif",0.052, 0.058)
...
## Uses FUNCTION correlated.param.SIM
