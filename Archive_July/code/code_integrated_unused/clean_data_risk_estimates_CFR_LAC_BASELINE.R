...
#Change the profile numbers to factors and name the variable
Pr.H <- as.data.frame(cbind(Pr.H,Profile))

#Change the name of the variable "Pr" to a more detailed name
Pr.H$Pr.H.Apr.20 <- Pr.H$Apr.20
Pr.H$Pr.H.Jul.20 <- Pr.H$Jul.20
Pr.H$Apr.20 <- NULL
Pr.H$Jul.20 <- NULL
...
#Change the profile numbers to factors and name the variable
Pr.Q <- as.data.frame(cbind(Pr.Q,Profile))

#Change the name of the variable "Pr" to a more detailed name
Pr.Q$Pr.Q.Apr.20 <- Pr.Q$Apr.20
Pr.Q$Pr.Q.Jul.20 <- Pr.Q$Jul.20
Pr.Q$Apr.20 <- NULL
Pr.Q$Jul.20 <- NULL
...
#Change the profile numbers to factors and name the variable
Pr.D <- as.data.frame(cbind(Pr.D,Profile))

#Change the name of the variable "Pr" to a more detailed name
Pr.D$Pr.D.Apr.20 <- Pr.D$Apr.20
Pr.D$Pr.D.Jul.20 <- Pr.D$Jul.20
Pr.D$Apr.20 <- NULL
Pr.D$Jul.20 <- NULL
...
data$Pr.D.I.Apr.20 <- data$Pr.H.Apr.20 * data$Pr.Q.Apr.20 * data$Pr.D.Apr.20
data$Pr.D.I.Jul.20 <- data$Pr.H.Jul.20 * data$Pr.Q.Jul.20 * data$Pr.D.Jul.20
...
data$riskprofile[data$Pr.D.I.Apr.20<.05] <- "Risk 5"
data$riskprofile[(data$Pr.D.I.Apr.20<.1) & (data$Pr.D.I.Apr.20>.05)] <- "Risk 4"
data$riskprofile[(data$Pr.D.I.Apr.20<.2) & (data$Pr.D.I.Apr.20>.1)] <- "Risk 3"
data$riskprofile[(data$Pr.D.I.Apr.20<.3) & (data$Pr.D.I.Apr.20>.2)] <- "Risk 2"
data$riskprofile[(data$Pr.D.I.Apr.20>.3)] <- "Risk 1"

# data$riskprofile[data$Pr.D.I.Apr.20<.00099] <- "Risk 5"
# data$riskprofile[(data$Pr.D.I.Apr.20<.01) & (data$Pr.D.I.Apr.20>.00099)] <- "Risk 4"
# data$riskprofile[(data$Pr.D.I.Apr.20<.03) & (data$Pr.D.I.Apr.20>.01)] <- "Risk 3"
# data$riskprofile[(data$Pr.D.I.Apr.20<.06) & (data$Pr.D.I.Apr.20>.03)] <- "Risk 2"
# data$riskprofile[(data$Pr.D.I.Apr.20>.07)] <- "Risk 1"
