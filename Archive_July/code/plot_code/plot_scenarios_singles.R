...
plot.model.single.SCENARIO <- function(traj.CI, data.in, init.date.data=NULL, date.offset.4plot=NULL, time.steps.4plot=NULL, ymax=NULL, plot.capacity=NULL, var.to.plot=NULL, use.title=NULL, scenario=NULL, intervention_date=NULL, sd.redux=NULL, scenario.no=NULL) {
...
plot.model.single.SCENARIO.XAxis <- function(traj.CI, data.in, init.date.data=NULL, date.offset.4plot=NULL, time.steps.4plot=NULL, ymax=NULL, plot.capacity=NULL, var.to.plot=NULL, use.title=NULL, scenario=NULL, intervention_date=NULL, sd.redux=NULL, scenario.no=NULL) {
...
for (i in 1:length(scenario.list)){
  ...
  ymax=16000
  plot.capacity=NULL
  plot.single.I[[i]] <- plot.model.single.SCENARIO(traj.CI=traj.scenario, data.in=data.in.tmp, init.date.data="2020-03-01", date.offset.4plot=0,
  ...
  ymax=17000
  plot.capacity=TRUE
  plot.single.H[[i]] <- plot.model.single.SCENARIO(traj.CI=traj.scenario, data.in=data.in.tmp, init.date.data="2020-03-01", date.offset.4plot=0,
  ...
  ymax=5000 #23000
  plot.capacity=NULL
  plot.single.D[[i]] <- plot.model.single.SCENARIO.XAxis(traj.CI=traj.scenario, data.in=data.in.tmp, init.date.data="2020-03-01", date.offset.4plot=0,
                                     time.steps.4plot=time.steps.4plot, ymax=ymax, plot.capacity=NULL, var.to.plot=var.to.plot,use.title=use.title,
                                     scenario=scenario, intervention_date=intervention_date, sd.redux=sd.redux)

}

# (plot.single.I[[1]] + plot.single.I[[2]] + plot.single.I[[3]] + plot.single.I[[4]]+ plot.single.I[[5]]+ plot.single.I[[6]]+ plot.single.I[[7]]+ plot.single.I[[8]]) / (plot.single.H[[1]] + plot.single.H[[2]]+ plot.single.H[[3]]+ plot.single.H[[4]]+ plot.single.H[[5]]+ plot.single.H[[6]]+ plot.single.H[[7]]+ plot.single.H[[8]]) / (plot.single.D[[1]] + plot.single.D[[2]]+ plot.single.D[[3]]+ plot.single.D[[4]]+ plot.single.D[[5]]+ plot.single.D[[6]]+ plot.single.D[[7]]+ plot.single.D[[8]]) + plot_layout(guides = 'collect')
#
#
# (plot.single.I[[1]] + plot.single.I[[2]] ) / (plot.single.H[[1]] + plot.single.H[[2]]) / (plot.single.D[[1]] + plot.single.D[[2]]) + plot_layout(guides = 'collect')


# combined.plot <- ggarrange( plot.single.I[[1]], plot.single.I[[2]], plot.single.I[[3]], plot.single.I[[4]], plot.single.I[[5]], plot.single.I[[6]], plot.single.I[[7]], plot.single.I[[8]],
...
## COMBINED PLOT
combined.plot <- ggarrange( plot.single.I[[1]], plot.single.I[[2]], plot.single.I[[3]], plot.single.I[[4]],  plot.single.I[[6]], plot.single.I[[7]],
...
#combined.plot.observed_Alpha_t <- combined.plot
#combined.plot.RiskModelCalculated_Alpha_t <- combined.plot
...
# * Plot together with and without xaxis
# * manually put in labels
# get Rt plot and Alphat plot
