...
D.dates.select <- c("2020-04-11","2020-04-16", "2020-05-01", "2020-05-11", "2020-05-17", "2020-05-20")
...
RR.D.per.Pop.barchart <-
  ...
  ylim(0,3)+
  scale_x_discrete(labels = race.order)
...
We see from this chart that the death rate relative to that for whites is predicted by our model to be lower for Latinx population, based on prevalence of risk factors for COVID-19, and this lower risk is observed in the data, both for deaths per population and deaths given illness. The death rate relative to whites for blacks is predicted to be almost identical to whites, and is observed to be slightly higher than whites both for deaths per population and deaths over illnesses.

### Death rates by race: nursing home cases removed (illustrative)

A different story emerges when we **remove from the observed numbers of illnesses and deaths the estimated numbers of counts** originating from outbreaks occurring in nursing homes (this serves as an illustration because exact numbers of illnesses and deaths by race are not available; for more details on how these cases are removed, see [Data](https://uscbiostats.github.io/COVID19/method.html#data)):
...
Because the majority of nursing home residents are white, once we remove the estimated counts from each race/ethnicity group from the overall numbers for deaths and illnesses, the relative share of deaths in the white population is greatly decreased and all other shares are proportionally increased. The result is a picture of the risk of death relative to whites which is significantly higher for all other races, both for overall risk of death and the risk of death conditioned upon illness. These large differences in risk are apparent even after conditioning by illnesses, effectively conditioning out the component of the risk accounted for by differences in exposure and spread dynamics. **In other words, all race/ethnicity groups are at significantly increased risk of death upon contracting the COVID-19 virus in comparison with whites. Most importantly, this significant increase in risk is not explainable by the risk factors for COVID-19 that are factored into our model, namely age, comorbidities, and health behaviors.**
