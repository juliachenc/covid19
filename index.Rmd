...
```{r}
## Note: Beta(t), Alpha(t), Kappa(t), Delta(t) are read in from file
prior_param_input_week2 <- path(code.paper.dir, "prior_paramw2.R")
source(prior_param_input_week1later)
...
## LOAD DATA PROCESSING AND MODEL ESTIMATING FUNCTIONS
## for week 1 later
model_functions_week1later <- path(code.paper.dir, "data_model_fun_w2.R")
source(model_functions_week1later)
