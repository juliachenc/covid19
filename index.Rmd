...
Here we provide model projections for the SEIR+Risk model in L.A. County. Projections are shown as the median number in compartments over time, with the 50% and 95% Confidence Intervals. Observed data is depicted for variables where data is available. Key healthcare capacity limits (hospital beds, ICU beds, ventilators) in L.A. County are also indicated.
...
Note: $Pr(Hospital|Illness)$ is the probability of hospitalization given **observed** illnesses.
...
D.dates.select <- c("2020-04-11","2020-04-16", "2020-05-01", "2020-05-11", "2020-05-17", "2020-05-20","2020-05-26","2020-05-31","2020-06-03")
...
SNF.race.distribution <- c(.18, .5, .11, 0, .19, 0.01,.01)
